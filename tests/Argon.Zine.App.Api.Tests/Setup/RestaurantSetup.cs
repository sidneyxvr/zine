...
public static class RestaurantSetup
{
    ...
    public static void SeedRestaurantDatabase(RestaurantContext context)
    {
        ...
        context.Database.ExecuteSqlRaw(@"INSERT INTO public.""User"" (""Id"", ""FirstName"", ""Surname"", ""Email"", ""IsActive"", ""IsDelete"", ""RestaurantId"", ""CreatedAt"") VALUES ('7df063d1-52b3-48ce-4dec-08da07c9ece1', 'Test', 'Test', 'confirmed_email@email.com', true, false, '02da557e-6b12-4eec-bb36-cd11b529831b', '2022-03-17 03:55:08.028039+00');");
    }
}