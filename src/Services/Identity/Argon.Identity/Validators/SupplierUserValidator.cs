...
{
    public class SupplierUserValidator : BaseValidator<SupplierUserRequest>
    {
        public SupplierUserValidator()
        {
            const int MaxLengthCorporateName = 50;
            const int MinLengthCorporateName = 5;
            const int MaxLengthTradeName = 50;
            const int MinLengthTradeName = 5;
