...
public class CategoryRepository : ICategoryRepository, IRepository<Category>
{
    ...
    public async Task<bool> ExistsByIdAsync(Guid id, CancellationToken cancellationToken = default)
        => await _context.Categories.AsNoTracking().AnyAsync(c => c.Id == id, cancellationToken);

    public async Task<bool> ExistsByNameAsync(string name, CancellationToken cancellationToken = default)
        => await _context.Categories.AsNoTracking().AnyAsync(c => c.Name == name, cancellationToken);
